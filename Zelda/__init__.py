...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/nmiabdfhmy/Zelda-Userbot.git"
)
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "github.com/nmiabdfhmy/Zelda-Userbot")
...
try:
    from Zelda.modules.sql_helper.globals import delgvar, gvarstatus
...
with bot:
    try:
        from Zelda.modules.sql_helper.bot_blacklists import check_is_black_list
        from Zelda.modules.sql_helper.bot_pms_sql import add_user_to_db, get_user_id
        from Zelda.utils import reply_id
