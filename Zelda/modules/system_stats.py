...
from Zelda import ALIVE_EMOJI, ALIVE_LOGO, ALIVE_TEKS_CUSTOM, BOT_VER, CHANNEL
from Zelda import CMD_HANDLER as cmd
from Zelda import CMD_HELP, GROUP, StartTime, bot
from Zelda.utils import bash, edit_or_reply, zelda_cmd
...
async def amireallyalive(alive):
    ...
    output = (
        f"**[ZELDA USERBOT](https://github.com/nmiabdfhmy/Zelda-Userbot)** by **[LORD ZELDA](https://t.me/UnrealZlda)**\n\n"
