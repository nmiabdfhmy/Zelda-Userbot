...
from Zelda import CMD_HELP, DEVS
from Zelda.events import register
from Zelda.utils import (
    _format,
    edit_delete,
    edit_or_reply,
    get_user_from_event,
...
async def spider(spdr):
    try:
        from Zelda.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    try:
        from Zelda.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    try:
        from Zelda.modules.sql_helper.gmute_sql import is_gmuted
        from Zelda.modules.sql_helper.spam_mute_sql import is_muted
    except AttributeError:
        return
...
async def ungmoot(un_gmute):
    ...
    try:
        from Zelda.modules.sql_helper.gmute_sql import ungmute
    except AttributeError:
...
async def gspider(gspdr):
    ...
    try:
        from Zelda.modules.sql_helper.gmute_sql import gmute
    except AttributeError:
