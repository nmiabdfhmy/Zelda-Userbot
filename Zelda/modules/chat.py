...
from Zelda import ALIVE_NAME, BLACKLIST_CHAT, BOTLOG, BOTLOG_CHATID
from Zelda import CMD_HANDLER as cmd
from Zelda import CMD_HELP, bot
from Zelda.events import zelda_cmd, register
from Zelda.modules.ping import absen
from Zelda.utils import edit_or_reply, get_user_from_event
...
async def unmute_chat(unm_e):
    try:
        from Zelda.modules.sql_helper.keep_read_sql import unkread
...
async def mute_chat(mute_e):
    try:
        from Zelda.modules.sql_helper.keep_read_sql import kread
    except AttributeError:
...
async def keep_read(message):
    try:
        from Zelda.modules.sql_helper.keep_read_sql import is_kread
    except AttributeError:
        return
    kread = is_kread()
    if kread:
