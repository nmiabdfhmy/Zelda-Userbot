...
from Zelda import BLACKLIST_CHAT, BOTLOG, BOTLOG_CHATID
...
async def filter_incoming_handler(handler):
    ...
    try:
        if not (await handler.get_sender()).bot:
            try:
                from Zelda.modules.sql_helper.filter_sql import get_filters
...
async def add_new_filter(new_handler):
    ...
    try:
        from Zelda.modules.sql_helper.filter_sql import add_filter
    except AttributeError:
...
async def remove_a_filter(r_handler):
    ...
    try:
        from Zelda.modules.sql_helper.filter_sql import remove_filter
    except AttributeError:
