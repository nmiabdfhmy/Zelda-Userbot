...
from Zelda import ALIVE_NAME, BOT_VER, BOTLOG, BOTLOG_CHATID
from Zelda import CMD_HANDLER as cmd
from Zelda import CMD_HELP, HEROKU_API_KEY, HEROKU_APP_NAME, UPSTREAM_REPO_BRANCH, bot
from Zelda.events import zelda_cmd
from Zelda.utils import time_formatter
...
async def reedme(e):
    await e.edit(
        ...
        "\n• [Userbot Repo](https://github.com/nmiabdfhmy/Zelda-Userbot/blob/Zelda-Ubot/README.md)"
